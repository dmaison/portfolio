...
const Component = (
    <svg className="navigation__item__icon" aria-hidden="true" focusable="false" data-prefix="far" data-icon="address-book" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
