...
export default (
    <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="id-card" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="svg-inline--fa fa-id-card fa-w-18">
