...
const Component = (
    <svg className="icon__image icon__image--stackOverflow" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="stack-overflow" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
